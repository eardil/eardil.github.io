...
I started with this thing called `IPython Notebook`, or `Jupyter`, which is really awesome and I'm actually writing this post on it. Jupyter is a Markdown interface, so that means there also \(\LaTeX\) $$\LaTeX$$ code!
